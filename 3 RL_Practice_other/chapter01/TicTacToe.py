...
if discover:
    ...
    key = allStates.keys()
    value = allStates.values()
    with open('states_key.pkl', 'wb') as f:
        pickle.dump(list(key), f)
    with open('states_value.pkl', 'wb') as f:
        pickle.dump(list(value), f)
else:
    with open('states_key.pkl', 'rb') as f:
        key = pickle.load(f)
    with open('states_value.pkl', 'rb') as f:
        value = pickle.load(f)
