...
def figure2_1():
    ...
    plt.savefig(str(figureIndex)+'.jpg')
...
def figure2_6(nBandits, time):
    ...
    bandits = [[generator(pow(2, float(param))) for _ in range(0, nBandits)] for generator, parameter in zip(generators, parameters) for param in parameter]
    _, averageRewards = banditSimulation(nBandits, time, bandits)
